		...
		while($row_user = mysqli_fetch_array($run_user))
		{
			...
			<div class='container-fluid'>
				<a style='text-decoration: none;cursor: pointer; color: #3897F0;' href='messages.php?u_id=$user_id'>
					<img class='img-circle' src='users/$user_name' width='90px' height='80px' title='$user_name'> <strong>&nbsp $first_name $last_name</strong><br><br>
				</a>
				...
				while($row_msg = mysqli_fetch_array($run_msg))
				{
					...
					<div id="loaded_msg">
						<p><?php if($user_to == $user_to_msg AND $user_from == $user_from_msg)
							{echo "<div class='message' id='blue' data-toggle='tooltip' title='$msg_dateg'>$msg_body</div><br><br><br>";}
				...
				<div class='row'>
					...
					<center>
						<div style='background-color: #e6e6e6;' class='col-sm-9'>
							...
							<img class='img-circle' src='user/$user_image' width='150' height='150'>
							<br><br>
							<ul class='list-group'>
